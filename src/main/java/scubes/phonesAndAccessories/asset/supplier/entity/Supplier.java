package scubes.phonesAndAccessories.asset.supplier.entity;
...
public class Supplier extends AuditEntity {
    ...
    private List< scubes.phonesAndAccessories.asset.purchaseOrder.entity.PurchaseOrder > purchaseOrders;
