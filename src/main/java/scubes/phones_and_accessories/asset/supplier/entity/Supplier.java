package scubes.phones_and_accessories.asset.supplier.entity;
...
public class Supplier extends AuditEntity {
    ...
    private List< scubes.phones_and_accessories.asset.purchase_order.entity.PurchaseOrder > purchaseOrders;
