...
import lk.scubes.phonesAndAccessories.util.service.OperatorService;
...
public class PaymentController {
    ...
    private final lk.crystal.asset.payment.service.PaymentService paymentService;
    private final PurchaseOrderService purchaseOrderService;
    private final OperatorService operatorService;
    private final GoodReceivedNoteService goodReceivedNoteService;
    private final MakeAutoGenerateNumberService makeAutoGenerateNumberService;

    public PaymentController(lk.crystal.asset.payment.service.PaymentService paymentService, PurchaseOrderService purchaseOrderService,
    ...
    public String getAllPurchaseOrderToPay(Model model) {
        ...
        if ( !purchaseOrdersDB.isEmpty() ) {
            ...
            for ( PurchaseOrder purchaseOrder : purchaseOrdersDB ) {
                List<lk.crystal.asset.payment.entity.Payment> payments = paymentService.findByPurchaseOrder(purchaseOrder);
                if ( payments != null ) {
                    BigDecimal paidAmount = BigDecimal.ZERO;
                    for ( lk.crystal.asset.payment.entity.Payment payment : payments ) {
