...
import lk.scubes.phonesAndAccessories.util.service.MakeAutoGenerateNumberService;
...
public class PurchaseOrderController {
    private final lk.crystal.asset.purchase_order.service.PurchaseOrderService purchaseOrderService;
    private final SupplierService supplierService;
    private final CommonService commonService;
    private final MakeAutoGenerateNumberService makeAutoGenerateNumberService;

    public PurchaseOrderController(lk.crystal.asset.purchase_order.service.PurchaseOrderService purchaseOrderService,
    ...
    @PostMapping( "/save" )
    public String purchaseOrderPersist(@Valid @ModelAttribute lk.crystal.asset.purchase_order.entity.PurchaseOrder purchaseOrder,
                                       BindingResult bindingResult, RedirectAttributes redirectAttributes) {
        if ( bindingResult.hasErrors() ) {
            return "redirect:/purchaseOrder/" + purchaseOrder.getId();
        }
        purchaseOrder.setPurchaseOrderStatus(lk.crystal.asset.purchase_order.entity.enums.PurchaseOrderStatus.NOT_COMPLETED);
        ...
        List<lk.crystal.asset.purchase_order_item.entity.PurchaseOrderItem> purchaseOrderItemList = new ArrayList<>();
        for ( lk.crystal.asset.purchase_order_item.entity.PurchaseOrderItem purchaseOrderItem : purchaseOrder.getPurchaseOrderItems() ) {
        ...
        lk.crystal.asset.purchase_order.entity.PurchaseOrder purchaseOrderSaved = purchaseOrderService.persist(purchaseOrder);
//todo-> PO email
    ...
    public String findAll(Model model) {
        model.addAttribute("purchaseOrders", purchaseOrderService.findAll()
                .stream()
                .filter(x -> x.getPurchaseOrderStatus().equals(lk.crystal.asset.purchase_order.entity.enums.PurchaseOrderStatus.NOT_COMPLETED))
    ...
    public String deletePurchaseOrderDetail(@PathVariable Integer id) {
        lk.crystal.asset.purchase_order.entity.PurchaseOrder purchaseOrder = purchaseOrderService.findById(id);
        purchaseOrder.setPurchaseOrderStatus(lk.crystal.asset.purchase_order.entity.enums.PurchaseOrderStatus.NOT_PROCEED);
