package lk.scubes_phone_and_accessories.asset.customer.controller;
...
//if customer has id that customer is not a new customer
        if (customer.getId() == null) {
            ...
            if (customerService.lastCustomer() == null) {
                ...
                customer.setCode("SPSC"+makeAutoGenerateNumberService.numberAutoGen(null).toString());
            } else {
                ...
                customer.setCode("SPSC"+makeAutoGenerateNumberService.numberAutoGen(previousCode).toString());
            }
            //send welcome message and email
            if (customer.getEmail() != null) {
                emailService.sendEmail(customer.getEmail(), "Welcome Message", "Welcome to Scubes Phones & Accessories...");
            }
            if (customer.getMobile() != null) {
            //    twilioMessageService.sendSMS(customer.getMobile(), "WScubes Phones");
            }
        }
